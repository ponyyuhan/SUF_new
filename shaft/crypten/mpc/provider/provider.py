...
class TupleProvider:
    ...
    def generate_trig_triple(self, size, period, terms, device=None):
        ...
        raise NotImplementedError("TupleProvider generate_trig_triple not implemented")
    
    def generate_one_hot_pair(self, size, length, device=None):
        # TODO: Implement generate_one_hot_pair() for TTP provider
        raise NotImplementedError("TupleProvider generate_one_hot_pair not implemented")
